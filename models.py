...
MODULES = [
    ...
    ('crm', 'Clienți (CRM)', 'bi-people'),
    ('nomenclator', 'Nomenclator Produse', 'bi-box'),
    ('configurator', 'Configurator', 'bi-gear'),
    ('oferte', 'Oferte', 'bi-file-earmark-text'),
    ('comenzi', 'Comenzi', 'bi-cart-check'),
    ('activitati', 'Activități (vizualizare)', 'bi-kanban'),
    ('activitati_status', 'Activități (schimbare status)', 'bi-toggle-on'),
    ('activitati_manage', 'Activități (gestiune completă)', 'bi-kanban-fill'),
    ('facturi', 'Facturi', 'bi-receipt'),
    ('wms', 'WMS Stoc', 'bi-box-seam'),
    ('cfg_admin', 'Admin Configurator', 'bi-sliders'),
    ('utilizatori', 'Utilizatori & Roluri', 'bi-person-gear'),
]
...
class ProdusConfig(db.Model):
    ...
    descriere = db.Column(db.Text)
    pret = db.Column(db.Float, default=0)
